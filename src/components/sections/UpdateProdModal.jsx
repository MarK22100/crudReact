...
const UpdateProdModal = ({ show, handleClose, producto, getProducts }) => {
  ...
  return (
    <Modal show={show} onHide={CloseModal} backdrop='static' data-bs-theme='dark' className="text-light" centered>
